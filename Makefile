...
pkgdatadir = $(datadir)/monoeciCore
pkgincludedir = $(includedir)/monoeciCore
pkglibdir = $(libdir)/monoeciCore
pkglibexecdir = $(libexecdir)/monoeciCore
...
CONFIG_HEADER = $(top_builddir)/src/config/monoeci-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/monoeci-config.h.in \
...
ACLOCAL = ${SHELL} /Users/sebastien/monoeci/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /Users/sebastien/monoeci/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /Users/sebastien/monoeci/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /Users/sebastien/monoeci/build-aux/missing automake-1.15
AWK = awk
BDB_CPPFLAGS = 
...
CRYPTO_CFLAGS = -I/usr/local/Cellar/openssl/1.0.2l/include
CRYPTO_LIBS = -L/usr/local/Cellar/openssl/1.0.2l/lib -lcrypto
CXX = g++
CXXCPP = g++ -E
...
MAINT = 
MAKEINFO = ${SHELL} /Users/sebastien/monoeci/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OBJCXXFLAGS = -g -O2 -Wall -Wextra -Wformat -Wformat-security -Wno-unused-parameter -Wno-self-assign
OBJDUMP = objdump
OBJEXT = o
OTOOL = otool
OTOOL64 = :
PACKAGE = monoeciCore
PACKAGE_BUGREPORT = https://github.com/monacocoin-net/monoeci-core
PACKAGE_NAME = monoeci Core
PACKAGE_STRING = monoeci Core 1.0.1
PACKAGE_TARNAME = monoeciCore
PACKAGE_URL = 
...
PKG_CONFIG_LIBDIR = 
PKG_CONFIG_PATH = /usr/local/Cellar/qt/5.9.2/lib/pkgconfig:/usr/local/opt/openssl/lib/pkgconfig:
PORT = 
PROTOBUF_CFLAGS = -D_THREAD_SAFE -I/usr/local/Cellar/protobuf/3.4.1/include
PROTOBUF_LIBS = -L/usr/local/Cellar/protobuf/3.4.1/lib -lprotobuf -D_THREAD_SAFE
...
SET_MAKE = 
SHELL = /bin/sh
SSL_CFLAGS = -I/usr/local/Cellar/openssl/1.0.2l/include
SSL_LIBS = -L/usr/local/Cellar/openssl/1.0.2l/lib -lssl
STRIP = /usr/bin/strip
...
X11XCB_LIBS = 
XGETTEXT = 
ZMQ_CFLAGS = -I/usr/local/Cellar/zeromq/4.2.2/include
ZMQ_LIBS = -L/usr/local/Cellar/zeromq/4.2.2/lib -lzmq
abs_builddir = /Users/sebastien/monoeci
abs_srcdir = /Users/sebastien/monoeci
abs_top_builddir = /Users/sebastien/monoeci
abs_top_srcdir = /Users/sebastien/monoeci
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /Users/sebastien/monoeci/build-aux/install-sh
...
BITCOIND_BIN = $(top_builddir)/src/monoecid$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/monoeci-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/monoeci-cli$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
OSX_APP = monoeci-Qt.app
OSX_DMG = monoeci-Core.dmg
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/monoeci-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/monoeci-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/monoeci-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/monoeci-config.h
$(top_srcdir)/src/config/monoeci-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/monoeci-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/monoeci-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
#$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/monoeci-Qt

#$(OSX_DMG): $(APP_DIST_EXTRAS)
#	$(GENISOIMAGE) -no-cache-inodes -D -l -probe -V "monoeci-Core" -no-pad -r -dir-mode 0755 -apple -o $@ dist
...
#$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/monoeci-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
# monoeci: disable the test until upstream switches from convoluted comparison tool
