...
Only requiring some minor changes is monoeci.cpp.
...
Changes to monoeci.cpp
----------------------
monoeci.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
