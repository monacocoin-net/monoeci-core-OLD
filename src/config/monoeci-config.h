/* src/config/monoeci-config.h.  Generated from monoeci-config.h.in by configure.  */
/* src/config/monoeci-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://github.com/monacocoin-net/monoeci-core"

/* Define to the full name of this package. */
#define PACKAGE_NAME "monoeci Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "monoeci Core 1.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "monoeciCore"
