...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 XMCC"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 XMCC"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 XMCC"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 XMCC"));
        ...
        labelBalance->setText(QStringLiteral("123.456 XMCC"));
...
#ifndef QT_NO_TOOLTIP
        checkBoxMinimumFee->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for XMCC transactions than the network can process.", 0));
#endif // QT_NO_TOOLTIP
        checkBoxMinimumFee->setText(QString());
#ifndef QT_NO_TOOLTIP
        labelMinFeeWarning->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for XMCC transactions than the network can process.", 0));
#endif // QT_NO_TOOLTIP
