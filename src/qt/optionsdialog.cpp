    ...
    mapper(0)
{
    ...
    /* Theme selector 
    /*ui->theme->addItem(QString("monoeci-light"), QVariant("light"));
    ui->theme->addItem(QString("monoeci-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("monoeci-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("monoeci-traditional"), QVariant("trad"));*/
