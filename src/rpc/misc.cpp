...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"monoeciaddress\"\n"
            "\nReturn information about the given monoeci address.\n"
            "\nArguments:\n"
            "1. \"monoeciaddress\"     (string, required) The monoeci address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"monoeciaddress\", (string) The monoeci address validated\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"monoeciaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"monoeciaddress\"  (string, required) The monoeci address to use for the signature.\n"
