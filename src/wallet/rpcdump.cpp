...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"monoeciaddress\"\n"
            "\nReveals the private key corresponding to 'monoeciaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"monoeciaddress\"   (string, required) The monoeci address for the private key\n"
            "\nResult:\n"
